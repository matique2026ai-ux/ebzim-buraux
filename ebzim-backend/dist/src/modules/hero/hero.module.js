...
const hero_slide_schema_1 = require("./schemas/hero-slide.schema");
...
exports.HeroModule = HeroModule = __decorate([
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([{ name: 'HeroSlide', schema: hero_slide_schema_1.HeroSlideSchema }]),
        ],
