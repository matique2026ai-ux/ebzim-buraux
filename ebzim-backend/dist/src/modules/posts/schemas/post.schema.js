...
exports.PostSchema = exports.Post = exports.MediaAttachment = void 0;
const mongoose_1 = require("@nestjs/mongoose");
const mongoose_2 = require("mongoose");
const institution_schema_1 = require("../../institutions/schemas/institution.schema");
let MediaAttachment = class MediaAttachment {
    type;
    cloudinaryUrl;
    publicId;
};
...
__decorate([
    (0, mongoose_1.Prop)({ type: String, enum: ['IMAGE', 'VIDEO', 'DOCUMENT'], required: true }),
    __metadata("design:type", String)
], MediaAttachment.prototype, "type", void 0);
__decorate([
    (0, mongoose_1.Prop)({ required: true }),
    __metadata("design:type", String)
], MediaAttachment.prototype, "cloudinaryUrl", void 0);
__decorate([
    (0, mongoose_1.Prop)({ required: true }),
    __metadata("design:type", String)
], MediaAttachment.prototype, "publicId", void 0);
exports.MediaAttachment = MediaAttachment = __decorate([
    (0, mongoose_1.Schema)({ _id: false })
], MediaAttachment);
const MediaAttachmentSchema = mongoose_1.SchemaFactory.createForClass(MediaAttachment);
let Post = class Post {
    authorId;
    categoryId;
    title;
...
__decorate([
    (0, mongoose_1.Prop)({ type: [MediaAttachmentSchema], default: [] }),
