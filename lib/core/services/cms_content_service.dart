...
final adminHeroSlidesProvider = FutureProvider<List<HeroSlide>>((ref) {
  return ref.watch(cmsContentServiceProvider).getAdminHeroSlides(location: 'HOME');
});

final adminOnboardingSlidesProvider = FutureProvider<List<HeroSlide>>((ref) {
  return ref.watch(cmsContentServiceProvider).getAdminHeroSlides(location: 'ONBOARDING');
});
