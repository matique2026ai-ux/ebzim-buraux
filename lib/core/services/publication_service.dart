  ...
  List<Publication> getPublications() {
    return [
      Publication(
        ...
        summaryAr: 'دراسة شاملة للمواقع الرومانية والبيزنطية في ولاية سطيف مع خرائط تفصيلية.',
        summaryEn: 'A comprehensive study of Roman and Byzantine sites in Setif with detailed maps.',
        summaryFr: 'Une étude complète des sites romains et byzantins à Sétif avec des cartes détaillées.',
      ...
      Publication(
        ...
        summaryAr: 'بحث حول آليات تفعيل دور المجتمع المدني في الرقابة الرقمية والمواطنة الفاعلة.',
        summaryEn: 'Research on mechanisms to activate the role of civil society in digital monitoring.',
        summaryFr: 'Recherche sur les mécanismes d\'activation du rôle de la société civile.',
        thumbnailUrl: 'https://images.unsplash.com/photo-1517486808906-6ca8b3f04846?q=80&w=800',
      ...
      Publication(
        ...
        summaryAr: 'حصيلة نشاطات جمعية إبزيم للسنة المالية 2024 والمشاريع المنجزة.',
        summaryEn: 'Summary of Ebzim Association activities for 2024 and completed projects.',
        summaryFr: 'Bilan des activités de l\'association Ebzim pour l\'année 2024.',
        thumbnailUrl: 'https://images.unsplash.com/photo-1450101499163-c8848c66ca85?q=80&w=800',
      ...
      Publication(
        ...
        summaryAr: 'دراسة تاريخية معمارية للثكنة العسكرية القديمة في الحامة وأهميتها التراثية.',
        summaryEn: 'Historical and architectural study of the old military barracks in El Hamman.',
        summaryFr: 'Étude historique et architecturale de l\'ancienne caserne d\'El Hamman.',
        thumbnailUrl: 'https://images.unsplash.com/photo-1516455590571-182363198889?q=80&w=800',
