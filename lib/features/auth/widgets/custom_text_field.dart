...
class _CustomTextFieldState extends State<CustomTextField> {
  ...
  Widget build(BuildContext context) {
    ...
    final textColor = widget.isDarkBackground ? Colors.white : AppTheme.textDark;
    final hintColor = widget.isDarkBackground ? Colors.white.withValues(alpha: 0.3) : AppTheme.textDark.withValues(alpha: 0.3);
