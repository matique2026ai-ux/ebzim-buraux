        ...
        children: [
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                _buildStep(1, loc.memStepper1),
                _buildDivider(1),
                _buildStep(2, loc.memStepper2),
                _buildDivider(2),
                _buildStep(3, loc.memStepper3),
                _buildDivider(3),
                _buildStep(4, loc.memStepper4),
              ],
            ),
          ),
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              const SizedBox(width: 16),
              Expanded(
                child: Text(loc.memConsent, style: const TextStyle(fontSize: 14, height: 1.5)),
              )
            ],
          ),
