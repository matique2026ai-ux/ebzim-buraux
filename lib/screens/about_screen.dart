                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      partnersAsync.when(
                        data: (partners) {
                          if (partners.isEmpty)
                            return _NoDataPlaceholder(isAr: isAr);
                          return Column(
                            children: partners
                                .map(
                                  (p) => _PartnerDossier(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Wrap(
                        spacing: 10,
                        runSpacing: 10,
                        children: _values(isAr, isFr)
                            .map((v) => _ValueChip(label: v, isDark: isDark))
                            .toList(),
                      ),
                    ],
                  ),
                ...
                child: _GlassSection(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _ResourceButton(
                        label: isAr
                            ? 'المكتبة الرقمية والبحوث'
                            : isFr
                            ? 'Bibliothèque et Recherches'
                            : 'Library & Research',
...
class _NoDataPlaceholder extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Padding(
    ...
    child: Center(
      child: Text(
        isAr ? 'لا توجد بيانات متاحة حالياً' : 'Aucune donnée disponible',
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(30),
        border: Border.all(
          color: AppTheme.accentColor.withValues(alpha: isDark ? 0.2 : 0.25),
        ),
      ),
      child: Row(
        mainAxisSize: MainAxisSize.min,
