...
class AboutScreen extends ConsumerWidget {
                    ...
                    child: Column(
                      ...
                      children: [
                        Container(
                          ...
                          child: Text(loc.culturalCurator, style: const TextStyle(color: Colors.white, fontSize: 10, fontWeight: FontWeight.bold, letterSpacing: 2)),
                        ),
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    loc.aboutStoryText1,
                    style: TextStyle(fontSize: 18, height: 1.6, color: Colors.white.withValues(alpha: 0.8)),
                  ),
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 16),
                        Text(loc.aboutHqText, style: TextStyle(fontSize: 16, height: 1.5, color: Colors.white.withValues(alpha: 0.8))),
                        const SizedBox(height: 24),
                        ElevatedButton(
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  const SizedBox(height: 16),
                  Text(loc.aboutQuoteAuthor.toUpperCase(), style: TextStyle(fontSize: 10, fontWeight: FontWeight.bold, letterSpacing: 2, color: Colors.white.withValues(alpha: 0.5))),
                ],
              ),
            ),
          ),
  ...
  Widget _buildValueCard(BuildContext context, {required IconData icon, required String title, required String desc, required bool isPrimary}) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: isPrimary ? AppTheme.primaryColor : AppTheme.primaryColor,
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          Text(desc, style: TextStyle(fontSize: 16, color: isPrimary ? Colors.white.withValues(alpha: 0.8) : Colors.white.withValues(alpha: 0.7))),
        ],
      ),
    );
  }
          ...
          ...values.map((v) => Padding(
            ...
            child: Row(
              children: [
                ...
                const SizedBox(width: 16),
                Text(v.toUpperCase(), style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold, letterSpacing: 2, color: Colors.white.withValues(alpha: 0.7))),
              ],
            ),
          ))
        ],
