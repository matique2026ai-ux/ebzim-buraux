...
class AdminCreateEventScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<AdminCreateEventScreen> createState() =>
      _AdminCreateEventScreenState();
}

class _AdminCreateEventScreenState
    extends ConsumerState<AdminCreateEventScreen> {
    ...
    try {
      ...
      final payload = {
        ...
        'title': {
          ...
          'fr': _titleArController.text.isNotEmpty
              ? _titleArController.text
              : ' ',
          'en': _titleArController.text.isNotEmpty
              ? _titleArController.text
              : ' ',
        },
        'description': {
          'ar': _descriptionArController.text.isNotEmpty
              ? _descriptionArController.text
              : ' ',
          'fr': _descriptionArController.text.isNotEmpty
              ? _descriptionArController.text
              : ' ',
          'en': _descriptionArController.text.isNotEmpty
              ? _descriptionArController.text
              : ' ',
        },
        ...
        'endDate': _selectedDate!
            ...
            .toIso8601String(),
        'location': {'formattedAddress': _addressController.text},
        'isOnline': _isOnline,
      ...
      if (isEditing) {
        await ref
            ...
            .updateEvent(widget.existingEvent!.id, payload);
      } else {
        await ref
            .read(eventServiceProvider)
            .createEvent(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildField(
                      ...
                      validator: (v) =>
                          v == null || v.isEmpty ? 'حقل مطلوب' : null,
