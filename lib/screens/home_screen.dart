                ...
                builder: (context) {
                  ...
                  return Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(
                        color: isDark ? AppTheme.accentColor.withOpacity(0.15) : AppTheme.primaryColor.withOpacity(0.08),
                        width: 1.5,
                      ),
                    ),
                    child: Row(
                      ...
                      children: [
                        ...
                        _StatDivider(),
                        _StatChip(value: '15+', label: lang == 'ar' ? 'عضو مؤسس' : 'Fondateurs'),
                        _StatDivider(),
                        _StatChip(value: '9', label: lang == 'ar' ? 'لجان متخصصة' : 'Comités'),
                        _StatDivider(),
                        _StatChip(value: '2', label: lang == 'ar' ? 'شراكة رسمية' : 'Partenariats'),
                      ],
                    ),
                  );
                },
