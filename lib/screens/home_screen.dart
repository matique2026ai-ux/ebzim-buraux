            ...
            child: Padding(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(color: theme.dividerTheme.color?.withOpacity(0.1) ?? Colors.transparent),
                ),
                child: Row(
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: isPrimary ? AppTheme.accentColor : Colors.white.withOpacity(0.1),
...
class _StatDivider extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      width: 1, 
      height: 32, 
      color: Theme.of(context).dividerTheme.color?.withOpacity(0.1) ?? Colors.grey.withOpacity(0.1)
    );
  }
}
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color: post.isPinned 
                ? AppTheme.heritageOrange.withOpacity(0.1) 
                : theme.dividerTheme.color?.withOpacity(0.1) ?? Colors.transparent,
          ...
          children: [
            ...
            Padding(
              ...
              child: Icon(
                ...
                color: isDark ? AppTheme.accentColor.withOpacity(0.1) : AppTheme.primaryColor.withOpacity(0.1),
              ),
            ),
          ],
        ),
...
class _InstitutionalCard extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    Color cardBgStrong = isDark ? const Color(0x12FFFFFF) : Colors.white.withOpacity(0.1);
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            borderRadius: BorderRadius.circular(20),
            border: Border.all(
              color: isDark ? iconColor.withOpacity(0.1) : iconColor.withOpacity(0.1),
              width: 1.5,
            ),
            boxShadow: [
              BoxShadow(
    ...
    return Row(
      children: [
        Container(
          ...
          child: Icon(icon, color: _kGold.withOpacity(0.1), size: 15),
        ),
        const SizedBox(width: 12),
        Text(
          label,
