...
class MembershipFlowScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<MembershipFlowScreen> createState() =>
      _MembershipFlowScreenState();
}
      ...
      child: Column(
        ...
        children: [
          ...
          _buildInput(
            ...
            loc.memFullName,
            state.fullName,
            (v) => notifier.updateField('fullName', v),
          ),
          ...
          _buildDatePicker(
            ...
            loc.memDOB,
            state.dob,
            (v) => notifier.updateField('dob', v),
          ),
          const SizedBox(height: 24),
          Text(
            loc.memGender.toUpperCase(),
            ...
            children: [
              Expanded(
                child: _buildRadio(
                  ...
                  'male',
                  state.gender,
                  (v) => notifier.updateField('gender', v),
                ),
              ),
...
class _Step2ContactForm extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final communes = ref
        .read(wilayaServiceProvider)
        .getCommunes(state.wilayaId);
        ...
        children: [
          ...
          _buildDropdown(
            ...
            wilayas
                ...
                .toList(),
            (v) => notifier.updateField('wilayaId', v),
          ),
          const SizedBox(height: 24),
          _buildDropdown(
            context,
            ...
            communes
                .map(
                  (c) => DropdownMenuItem(value: c.id, child: Text(c.nameEn)),
                )
                .toList(),
            (v) => notifier.updateField('communeId', v),
          ),
          const SizedBox(height: 24),
          _buildInput(
            context,
            loc.memPhone,
            state.phone,
            (v) => notifier.updateField('phone', v),
            hint: loc.memPhoneHint,
          ),
          const SizedBox(height: 24),
          _buildInput(
            context,
            'Email',
            state.email,
            (v) => notifier.updateField('email', v),
          ),
        ],
      ),
    );
          ...
          Wrap(
            ...
            children: realCommittees.map((committee) {
              ...
              return FilterChip(
                ...
                selected: isSelected,
                onSelected: (_) =>
                    notifier.toggleList('interests', committee['id']!),
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            isAr
                ? 'يرجى تحميل نسخة من بطاقة الهوية وصورة شخصية حديثة'
                : 'Please upload a copy of your ID and a recent photo',
