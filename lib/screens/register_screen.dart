...
class _RegisterScreenState extends ConsumerState<RegisterScreen> {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        shape: RoundedRectangleBorder(
          ...
          side: const BorderSide(color: AppTheme.accentColor, width: 0.5),
        ),
        title: Text(
  ...
  Widget build(BuildContext context) {
    ...
    String getErrorMessage(String key) {
      switch (key) {
        case 'authErrorConflict':
          return isRtl
              ? 'هذا البريد الإلكتروني مسجل مسبقاً.'
              : 'This email is already registered.';
        case 'authErrorInvalid':
          return loc.authErrorInvalid;
        case 'authErrorNoConnection':
          return loc.authErrorNoConnection;
        case 'authErrorUnknown':
          return loc.authErrorUnknown;
        default:
          return key;
      }
    }
    ...
    ref.listen<AuthState>(authProvider, (previous, next) {
      ...
      } else if (next.isEmailVerificationRequired &&
          next.emailForVerification != null) {
        context.push(
          '/auth/verify-email/otp',
          extra: next.emailForVerification,
        );
                                        ...
                                        child: ElevatedButton(
                                          ...
                                          style: ElevatedButton.styleFrom(
                                            backgroundColor: AppTheme
                                                .accentColor, // Premium Unified Gold
